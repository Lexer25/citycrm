...
<div class="onecolumn">
	<div class="header">
		...
		<span><?php echo __('contacts.title'); if (isset($company)) echo ' - ' . iconv('CP1251', 'UTF-8', $company['NAME']); ?></span>
					...
					<tr>
						...
						<td>
							...
							<?php if (Arr::get($pep,'IS_ACTIVE') == 1) { ?>
									<a href="javascript:" onclick="if (confirm('<?php echo __('contacts.confirmdelete'); ?>')) location.href='<?php echo URL::base() . 'contacts/delete/' . $pep['ID_PEP']; ?>';">
